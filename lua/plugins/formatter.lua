...
require("formatter").setup({
	...
	filetype = {
		...
		typescript = { copyf_with_params(prettierFormat, "typescript", "2") },
		typescriptreact = { copyf_with_params(prettierFormat, "typescriptreact", 2) },
		javascript = { copyf_with_params(prettierFormat, nil, "2") },
		javascriptreact = { copyf_with_params(prettierFormat, nil, "2") },
